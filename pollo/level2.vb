Public Class level2
    ...
    Const AXEPRICE As Integer = 80
    Const POWERPRICE As Integer = 50
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        For index = 0 To NUMBALL
            ...
            Call checkAxe(index)
        Next index
        If isTouching(tim, axe) = True Then
            tStuff.hasAxe = True
            Call animateAxe()
        End If
    ...
    End Sub
    Private Sub checkAxe(ByVal index As Integer)
        If tStuff.hasAxe = True And direction = Keys.ControlKey Then 'check if pressing button and has axe
            If isTouching(axe, ball(index)) = True And tStuff.useAxe = True Then 'then check if u
                ' bStuff(index).speed.X = 0 'using axe
                ball(index).Left = 900
                ball(index).Top = 600
            ElseIf isTouching(tim, ball(index)) = True And tStuff.useAxe = False Then
                Call killTim()
            End If
        ElseIf isTouching(tim, ball(index)) = True Then
            Call killTim()
        End If
    End Sub
    ...
    Private Sub animateTim()
        ...
        End If
    End Sub
    Private Sub animateAxe()
        If tStuff.isFacingRight = True Then
            axe.Left = tim.Left + 10
            axe.Top = tim.Top + 8
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerRightSmasher1.jpg")
        Else
            axe.Left = tim.Left - 10
            axe.Top = tim.Top + 8
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerLeftSmasher1.jpg")
        End If
    End Sub
    ...
    Private Sub animatLeft()
        ...
        End If
    End Sub
    Private Sub animateRightSmash()
        If tStuff.picNum = 1 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerRightSmasher1.jpg")
            tStuff.picNum = 2
        ElseIf tStuff.picNum = 2 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerRightSmasher2.jpg")
            tStuff.picNum = 3
        ElseIf tStuff.picNum = 3 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerRightSmasher1.jpg")
            tStuff.picNum = 4
        ElseIf tStuff.picNum = 4 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerRightSmasher2.jpg")
            tStuff.picNum = 1
        End If
    End Sub
    Private Sub animateLeftSmash()
        If tStuff.picNum = 1 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerLeftSmasher1.jpg")
            tStuff.picNum = 2
        ElseIf tStuff.picNum = 2 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerLeftSmasher2.jpg")
            tStuff.picNum = 3
        ElseIf tStuff.picNum = 3 Then
            axe.Image = Image.FromFile(IO.Path.GetDirectoryName(Application.ExecutablePath) & "\pics\hammerLeftSmasher1.jpg")
            tStuff.picNum = 4
    ...
    Private Sub level2_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        ...
        If direction = Keys.ControlKey And tStuff.hasAxe = True Then
            tStuff.useAxe = True
            If tStuff.isFacingRight = True Then
                Call animateRightSmash()
            Else
                Call animateLeftSmash()
            End If
        End If
    End Sub
    ...
    End Sub
    Private Sub buyAxe_Click(sender As Object, e As EventArgs) Handles buyAxe.Click
        clickNum = clickNum + 1
        If cash.Text >= AXEPRICE And tStuff.hasAxe = False Then
            cash.Text = cash.Text - AXEPRICE
            Call animateAxe()
        ElseIf clickNum > 1 And tStuff.hasAxe = True Then
            Call animateAxe()
        End If
    End Sub
